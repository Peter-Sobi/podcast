...
RSS_URL = "https://r.jina.ai/https://r.jina.ai/https://r.jina.ai/https://apolut.net/podcast/rss"
HTML_PROXY = "https://r.jina.ai/https://r.jina.ai/https://r.jina.ai/"
...
def find_latest_tagesdosis():
    html = fetch(HTML_PROXY + "https://apolut.net/")

    # DEBUG 1
    print("Homepage length:", len(html) if html else "None")
...
def process_tagesdosis():
    ...
    html = fetch(HTML_PROXY + url)

    # DEBUG 2
    print("Tagesdosis page length:", len(html) if html else "None")
...
def process_rss():
    ...
    # DEBUG 3
    print("RSS length:", len(xml) if xml else "None")
