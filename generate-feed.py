...
def extract_mp3_from_page(url: str) -> str | None:
    """Fallback 1: MP3-URL direkt von der Episodenseite extrahieren."""
...
def try_construct_mp3_urls(date: str, title: str) -> list[str]:
    """Fallback 2: Mögliche MP3-Dateinamen automatisch konstruieren."""
...
def check_url_exists(url: str) -> bool:
    """HEAD-Request prüfen, ob Datei existiert."""
    try:
...
def main():
    ...
    items = items   # alle Episoden verarbeiten
