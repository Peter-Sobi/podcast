...
SCRAPER_KEY = "8368ff7ec0012026884dec3d12d8499e"

def sp(url: str) -> str:
    return f"https://api.scraperapi.com/?api_key={SCRAPER_KEY}&url={url}"

RSS_URL = sp("https://apolut.net/podcast/rss")
