...
<enclosure url="https://peter-sobi.github.io/podcast/media_auf1/{t['local_mp3']}" length="{t['filesize']}" type="audio/mpeg"/>
<guid isPermaLink="false">{t['local_mp3']}</guid>
...
def main():
    ...
    for item in items:
        ...
        item["filesize"] = mp3_file.stat().st_size
