...
# Titel: direkt aus dem Feed, KEINE Titel-Datenbank
...
def build_feed(files, title_map):
    xml = ""
    for fn in files:
        title = title_map.get(fn, fn)  # Falls Titel fehlt → Dateiname
        url = BASE_URL + fn
...
def main():
    ...
    # Titel-Mapping NUR aus dem aktuellen Feed
    title_map = {}
    ...
    for entry in feed.entries:
        ...
        title_map[filename] = title  # Titel speichern
    ...
    print("Building feed…")
    build_feed(newest_20, title_map)
