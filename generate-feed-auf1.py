...
# KONFIGURATION
# ---------------------------------------------------------
RSS_URL = "https://podcasts.apple.com/de/podcast/auf1-podcast/id1546275375?uo=4&ls=1&at=11l79Y"  # AUF1 Apple RSS
...
def build_feed():
    ...
    <rss version="2.0">
      <channel>
        ...
        <description>Automatisch komprimierte Version für FRITZ!Box</description>
        {''.join(items)}
      </channel>
    </rss>
    """
