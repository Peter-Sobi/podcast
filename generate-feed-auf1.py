#!/usr/bin/env python3
# generate-feed-auf1.py – tägliche Version

import feedparser, requests, os, re, sys, time, subprocess, logging, html
...
def main():
    ...
    items = []
    for e in feed.entries:   # <<< tägliche Version: ALLE Einträge
        r = process(e)
        if r:
