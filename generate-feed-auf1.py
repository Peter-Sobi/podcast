...
def extract_date_from_url(url):
    """
    Extrahiert YYYYMMDD aus AUF1-Dateinamen.
...
def main():
    ...
    if not rss_items:
        log("[auf1] FEHLER: RSS enthält keine Items – Abbruch.")
        sys.exit(0)
    ...
    if not downloaded_items:
        log("[auf1] WARNUNG: Keine MP3-Episoden gefunden – alter Feed bleibt bestehen.")
        sys.exit(0)
