...
# KONFIGURATION
# ---------------------------------------------------------
RSS_URL = "HIER_DEIN_APPLE_RSS_LINK"   # Apple AUF1 RSS
...
def process_episodes():
    ...
    entries = feed.entries[:20]  # immer die 20 neuesten
...
# ---------------------------------------------------------
# SCHRITT 2: FEED BAUEN (NUR WENN release_urls.txt EXISTIERT)
# ---------------------------------------------------------
def build_feed():
...
# ---------------------------------------------------------
# MAIN – erkennt automatisch, was zu tun ist
# ---------------------------------------------------------
if __name__ == "__main__":
    # 1) Episoden laden & konvertieren
    process_episodes()

    # 2) Feed bauen (falls release_urls.txt schon existiert)
    build_feed()
